...
# ---------- Config UI ----------
st.set_page_config(page_title="TiendaTec • Chat IA", page_icon="📱", layout="wide")
st.title("📱🛒 Chat de Tienda de Tecnología (Demo)")
st.caption("Consulta el inventario de celulares, accesorios y cámaras. Demo para portafolio.")
...
@st.cache_data
def load_inventory(path="data/inventario.csv"):
    df = pd.read_csv(path)
